  ...
  return (
    <button
      className={cn(
        ...
        "cursor-pointer bg-violet-600 shadow-[8px_8px_0px_rgba(255,255,255,0.08)] transition-all duration-300 ease-in-out",
        "hover:translate-y-[5px] hover:shadow-[3px_3px_0px_rgba(255,255,255,0.08)]",
    ...
    >
      ...
      >
        ...
        <path fill="#8b5cf6" d="M1285.89,749.79c-.25,297.07-241.24,535.86-536.12,535.66-296.34-.21-537-241.72-535.29-539,1.68-293.16,240.83-534.18,539.15-532.37C1046.8,215.84,1285.62,453.88,1285.89,749.79Z" transform="translate(-202.29 -201.89)"/>
        ...
        <path fill="#06b6d4" d="M1097.23,749.87c.22,190.31-154.42,347.43-348,346.92-192-.5-346.48-156.44-346.17-347.7C403.33,558,558.18,402,751.08,402.55,944.62,403.09,1097.69,560.56,1097.23,749.87Z" transform="translate(-202.29 -201.89)"/>
        <path fill="rgba(139,92,246,0.2)" d="M1006.72,744.28c2.81,143.23-110.17,257.35-247.42,261.9C613.15,1011,498.22,895.93,493.71,758.88,488.93,613.71,603,498,740.69,493.28,886.73,488.24,1004,603.87,1006.72,744.28Z" transform="translate(-202.29 -201.89)"/>
      ...
      <span className="z-10 font-mono font-bold text-xs uppercase tracking-wider text-white transition-colors duration-300 group-hover:text-transparent">
        {children}
      </span>
    </button>
  );
